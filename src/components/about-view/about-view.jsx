...
export const AboutView = () => {
  ...
  return (
    <Container className="justify-content-center">
      <Row className="about card justify-content-center">
        <Col lg={7} className="col-12 aboutText">
          ...
          <br /><br />
          Currently, I am a student in the Full-Stack Web Development program at CareerFoundry while working as a Home Health Aide.
        </Col>
            ...
            <Row className="col-12 mt-5 justify-content-center">
              ...
              <Col className="tableRight col-9 tableText">
                <Row className="cellBorder">
                  ...
                  <Col lg={4} className="col-2 skillBorder">JS (+ REACT, REACT NATIVE)</Col>
                ...
                <Row className="cellBorder">
                  ...
                  <Col lg={4} className="col-2 skillBorder">
                    {duration(coreSkills) < 3
                      ? `junior` : duration(coreSkills) < 7
                        ? `mid`
                        : `senior`}
