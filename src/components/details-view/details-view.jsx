  ...
  return (
    <>
      {!project
        ...
        :
        <Container>
          <Col className="card projectDetails">
            <Row>
            ...
            <Row>
              ...
              <Row className="projectButtons mb-5">
                {project.live ?
                  <Button href={project.live} target="_blank" variant="primary" className="primaryButton mt-5">
                    CHECK IT OUT
                  </Button>
                  :
                  <div className="disabledButton mt-5">
                    No live website available
                  </div>}
                <Button href={project.github} target="_blank" variant="primary" className="primaryButton mt-1">
                  GITHUB
                </Button>
                <Button className="primaryButton mt-1" variant="primary" onClick={() => navigate(-1)}>
                  Back
                </Button>
              </Row>
            </Row>
