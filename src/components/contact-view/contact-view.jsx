...
export const ContactView = () => {
  ...
  return (
    <Container className="card contact">
        ...
        <Col xl={6} lg={8} className="col-12">
          <Button href="tel:+17578488210" className="primaryButton mt-2">
            <Row style={{ textAlign: "right", marginLeft: "5px" }}>
              <Col className="col-4 contactType">call</Col>
      ...
      <Row className="justify-content-center">
        <Col xl={6} lg={8} className="col-12 mb-5">
          <Button href="mailto:emnnichols@outlook.com" className="primaryButton mt-2">
            <Row style={{ textAlign: "right", marginLeft: "5px" }}>
              <Col className="col-4 contactType">email</Col>
      ...
      <Card.Title className="mb-4 formTitle">
        OR ... SEND a MESSAGE
      </Card.Title>
